<template>
    <div>
        ...
        <!--//播放控件  mbn网站-->
        <div class="audio">
            <!--//ref属性是vue里自带的 是一个属性给他起个名 作用是通过ref获取到当前的真是的dom结构 也就是html标签-->
            <!--获取的话通过 this.$refs.musicAudio.-->
...
<script>
    ...
    export default {
        ...
        watch: {
            //nowIndex表示当前选中歌曲的索引，如果索引有变化那么对应的标题等都变化。一个属性的变化会引起很多属性的变化所以
            nowIndex() {
